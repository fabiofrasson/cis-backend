...
public class HealthProfessionalService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        return this.healthProfessionalRepository.findByEmail(email).orElseThrow(() -> new UsernameNotFoundException("Invalid Email or Password"));
    }

    public HealthProfessionalResponseDTO findById(UUID id){
        HealthProfessional healthProfessional = healthProfessionalRepository.findById(id).orElseThrow(() -> new BadRequestException("User Not Found"));
    ...
    public HealthProfessionalResponseDTO create(HealthProfessionalCreationDTO entity){
        ...
        Optional<HealthProfessional> emailAlreadyExists = healthProfessionalRepository.findByEmail(entity.getEmail());
