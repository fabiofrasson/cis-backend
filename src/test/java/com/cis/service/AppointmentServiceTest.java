...
public class AppointmentServiceTest {
    ...
    void test_create() throws ParseException {
        var appointmentResponseDTO = appointmentService.create(AppointmentCreator.appointmentToSave());

        Assertions.assertThat(appointmentResponseDTO).isNotNull();
        Assertions.assertThat(appointmentResponseDTO.equals("Appointment Created with Success")).isTrue();
    }

    @Test
    @DisplayName("Should update Appointment")
    void test_update() throws ParseException {
        String update = appointmentService.update(UUID.randomUUID(), AppointmentCreator.appointmentToSave());
